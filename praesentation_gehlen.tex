...
% -------------------------------------------------------------
\begin{frame}{Reaktivierung: Selbstliebe vs. Eigenliebe bei Rousseau}
    \vspace{-0.3cm}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{tcolorbox}[rousseauNature, title={\faLeaf\ amour de soi-même (Selbstliebe)}]
                \textbf{Der Mensch im Naturzustand}
                \begin{itemize}\setlength{\itemsep}{1pt}\footnotesize
                    \item \textbf{Ursprung:} Natürlich \& angeboren
                    \item \textbf{Ziel:} Selbsterhaltung \& vitale Bedürfnisse
                    \item \textbf{Wesen:} \textcolor{accentGreen}{\textbf{Absolut \& nicht vergleichend}}
                    \item \textbf{Korrektiv:} Verbunden mit \textit{pitié} (Mitleid)
                    \item \textbf{Gefühl:} Ruht ganz in sich selbst
                \end{itemize}
            \end{tcolorbox}
        \end{column}

        \begin{column}{0.48\textwidth}
            \begin{tcolorbox}[rousseauCulture, title={\faMask\ amour-propre (Eigenliebe / Selbstsucht)}]
                \textbf{Der Mensch im Gesellschaftszustand}
                \begin{itemize}\setlength{\itemsep}{1pt}\footnotesize
                    \item \textbf{Ursprung:} Künstlich, durch Kultur \& Besitz
                    \item \textbf{Ziel:} Geltung, Status (\glqq Mehr sein als andere\grqq)
                    \item \textbf{Wesen:} \textcolor{accentRed}{\textbf{Relational \& permanent vergleichend}}
                    \item \textbf{Folge:} Konkurrenz, Missgunst, Neid
                    \item \textbf{Zustand:} \textbf{Entfremdung} – Leben im Schein
                \end{itemize}
            \end{tcolorbox}
        \end{column}
    \end{columns}
    ...
    \vspace{0.15cm}
    \begin{tcolorbox}[enhanced, colframe=primaryBlue, colback=lightBlue, arc=2mm, boxrule=0.6pt, left=6pt, right=6pt, top=2pt, bottom=2pt]
        \centering\footnotesize
        \textbf{Rousseaus Bilanz:} Der Mensch ist von Natur aus lebensfähig und gut – erst Kultur und Vergesellschaftung korrumpieren ihn!
    \end{tcolorbox}
\end{frame}
